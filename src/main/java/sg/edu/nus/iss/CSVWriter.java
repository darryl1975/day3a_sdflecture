...
public class CSVWriter {
    ...
    public List<Employee> generateEmployees() {
        ...
        Employee emp2 = new Employee("12345", "Arun", "Infrastructure", "Infra Engineer", "arun@visa.com", 12000);
        Employee emp3 = new Employee("12346", "Bryan", "Lisa", "Tech Architect", "lisa@visa.com", 8000);
